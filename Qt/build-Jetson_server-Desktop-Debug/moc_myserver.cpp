...
#include "../Jetson_server/myserver.h"
...
QT_MOC_LITERAL(4, 33, 18), // "processTextMessage"
QT_MOC_LITERAL(5, 52, 7), // "message"
QT_MOC_LITERAL(6, 60, 18) // "socketDisconnected"

    },
    "MyServer\0closed\0\0onNewConnection\0"
...
void MyServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyServer::closed)) {
                *result = 0;
                return;
            }
        }
